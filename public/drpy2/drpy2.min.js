import cheerio from"./cheerio.min.js";import 模板 from"./模板.js";import{gbkTool}from"./gbk.min.js";import"./crypto-js.min.js";import"./jsencrypt.min.js";import"./node-rsa.js";import"./pako.min.js";import"./json5.min.js";import"./jinja.min.js";import"./polywasm.min.js";const _jinja2=cheerio.jinja2;cheerio.jinja2=function(template,obj){try{return jinja.render(template,obj)}catch(e){console.log("新的jinja2库渲染失败,换回原始cheerio:"+e.message);return _jinja2(template,obj)}};let vercode=typeof pdfl==="function"?"drpy2.1":"drpy2";const VERSION=vercode+" 3.9.52beta1 20250728";const UpdateInfo=[{date:"20250728",title:"drpy更新，增加tab_order线路模糊排序，优化解密算法支持文件头",version:"3.9.52beta1 20250728",msg:`
 1. 增加tab_order线路模糊排序 
 2. 优化解密算法支持文件头
 3. wasm支持
